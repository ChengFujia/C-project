...
{
	// 对于Planet类，属于不发光的星球，要绘制它的光照效果(材质)
...
{
	// 对于LightPlanet类，属于发光的星球，所以不但要设置光照材质，还要设置（光源）位置
	...
	glLightfv(GL_LIGHT0,GL_AMBIENT,light_ambient);		// 多种光线照射，经过多次反射后遗留在环境中的光线强度
